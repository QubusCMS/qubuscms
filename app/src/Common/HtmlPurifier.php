...
/**
 * This class is inspired by Drupal's HTML purifier class.
 */

final class HtmlPurifier implements HtmlPurifierInterface
{
     ...
     * @param bool   $is_image   Is the string an image?
