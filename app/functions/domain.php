...
function load_plugin_textdomain($domain, $plugin_rel_path = false)
{
     ...
     */
    $plugin_locale = ActionFilterHook::getInstance()->applyFilter('plugin_locale', $locale, $domain);
...
function load_textdomain($domain, $path)
{
     ...
     * @param string $path   Path to the .mo file.
     */
    $plugin_override = ActionFilterHook::getInstance()->applyFilter('override_load_textdomain', false, $domain, $path);
     ...
     * @param string $path Path to the .mo file.
     */
    ActionFilterHook::getInstance()->doAction('load_textdomain', $domain, $path);
     ...
     * @param string $domain Text domain. Unique identifier for retrieving translated strings.
     */
    $mofile = ActionFilterHook::getInstance()->applyFilter('load_textdomain_mofile', $path, $domain);
...
function load_core_locale()
{
    ...
    return ActionFilterHook::getInstance()->applyFilter('core_locale', $locale);
}
