...
trait TriggerErrorTrait
{
    ...
    public function deprecatedFunction($function_name, $release, $replacement = null)
    {
         ...
         */
        if (APP_ENV == 'DEV' && ActionFilterHook::getInstance()->applyFilter(
    ...
    public function deprecatedMethod($method_name, $release, $replacement = null)
    {
         ...
         * @since 1.0.0
         *
         * @param bool $trigger Whether to trigger the error for deprecated class methods. Default true.
         */
        if (APP_ENV == 'DEV' && ActionFilterHook::getInstance()->applyFilter(
    ...
    public function incorrectlyCalled($function_name, $message, $release)
    {
         ...
         * @since 1.0.0
         *
         * @param bool $trigger Whether to trigger the error for _incorrectly_called() calls. Default true.
         */
        if (APP_ENV == 'DEV' && ActionFilterHook::getInstance()->applyFilter(
