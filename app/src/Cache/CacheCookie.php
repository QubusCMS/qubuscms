...
{
    use \Qubus\Traits\FileSystemTrait;
    ...
    public function read($key, $namespace = 'default')
    {
        ...
        $get_data = $this->getContents($filename, LOCK_EX);

        $data = $this->unserialize($get_data);
    ...
    {
        echo "<p>";
        echo "<strong>Cache Hits:</strong> " . $this->getContents(
            $this->dir . 'cache_hits.txt'
        ) . "<br />";
        echo "<strong>Cache Misses:</strong> " . $this->getContents(
