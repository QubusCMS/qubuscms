...
ActionFilterHook::getInstance()->doAction('admin_init');
$option = (
...
<html lang="en">
    <head>
        ...
        <title><?= $this->title . ' &lsaquo; ' . $option->{'read'}('sitename'); ?> &#8212; <?= esc_html__('Qubus CMS'); ?></title>
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <nav class="navbar navbar-static-top">
                    ...
                    <?php if (!function_exists('show_ttcms_adminbar')) : ?>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <?= get_user_avatar($user->getEmail(), 160, 'image-circle'); ?>
                                        ...
                                        <p>
                                            ...
                                            <small><?= esc_html__('Member since'); ?> <?= (new \TriTan\Common\Date())->{'db2date'}('M Y', $user->getRegistered()); ?></small>
                                        </p>
                                    </li>
                                    <!-- Menu Footer-->
                                    <li class="user-footer">
                                        ...
                                        <div class="pull-right">
                                            <a href="<?= logout_url(login_url()); ?>" class="btn btn-default btn-flat"><?= esc_html__('Logout'); ?></a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview<?= (c::getInstance()->get('screen_parent') === 'dashboard' ? ' active' : ''); ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <?php ActionFilterHook::getInstance()->doAction('dashboard_submenu'); ?>
                            </ul>
                        </li>
                        <li<?= ae('manage_settings'); ?> class="treeview">
                            <a href="<?= admin_url('flush-cache/'); ?>">
                                <i class="fa fa-broom"></i> <span><?= esc_html__('Flush Cache'); ?></span>
                            </a>
                        </li>
                        <li<?= ae('manage_sites'); ?> class="treeview<?= (c::getInstance()->get('screen_parent') === 'sites' ? ' active' : ''); ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <?php ActionFilterHook::getInstance()->doAction('sites_submenu'); ?>
                            </ul>
                        </li>
                        <li<?= ae('manage_posts'); ?> class="treeview<?= (c::getInstance()->get('screen_parent') === 'post_types' ? ' active' : ''); ?>">
                            <a href="<?= admin_url('post-type/'); ?>">
                                <i class="fa fa-cubes"></i> <span><?= esc_html__('Post Types'); ?></span>
                            </a>
                        </li>
                        <?php foreach (get_all_posttypes() as $post_type) : ?>
                            <li<?= ae('manage_posts'); ?> class="treeview<?= (c::getInstance()->get('screen_parent') === esc_attr($post_type->getSlug()) ? ' active' : ''); ?>">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <?php ActionFilterHook::getInstance()->doAction('posttype_submenu', esc_html($post_type->getSlug())); ?>
                                </ul>
                            </li>
                        <?php endforeach; ?>
                        <?php ActionFilterHook::getInstance()->doAction('posttype_menu'); ?>
                        ...
                        <li<?= ae('manage_plugins'); ?> class="treeview<?= (c::getInstance()->get('screen_parent') === 'plugins' ? ' active' : ''); ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <?php ActionFilterHook::getInstance()->doAction('plugins_submenu'); ?>
                            </ul>
                        </li>
                        ...
                        <li class="treeview<?= (c::getInstance()->get('screen_parent') === 'users' ? ' active' : ''); ?>">
                            ...
                            <ul class="treeview-menu">
                                <?php ActionFilterHook::getInstance()->doAction('admin_submenu_users'); ?>
                                ...
                                <?php ActionFilterHook::getInstance()->doAction('users_submenu'); ?>
                            </ul>
                        </li>
                        <?php else : ?>
                        <li>
                        ...
                        <li<?= ae('manage_roles'); ?> class="treeview<?= (c::getInstance()->get('screen_parent') === 'roles') ? ' active' : ''; ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <?php ActionFilterHook::getInstance()->doAction('role_submenu'); ?>
                            </ul>
                        </li>
                        <li<?= ae('manage_options'); ?> class="treeview<?= (c::getInstance()->get('screen_parent') === 'options') ? ' active' : ''; ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <?php ActionFilterHook::getInstance()->doAction('options_submenu'); ?>
                            </ul>
                        </li>
                        <li>
                            <a href="//github.com/QubusCMS/cms">
                                <i class="fa fa-ticket-alt"></i> <span><?= esc_html__('Submit Issue'); ?></span>
                            </a>
                        </li>
                    </ul>
                </section>
