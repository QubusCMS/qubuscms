...
TriTan\Common\Container::getInstance()->{'set'}('screen_parent', 'post_types');
?>
                        ...
                        <?php foreach ($this->posttypes as $posttype) : ?>
                            <tr class="gradeX">
                                ...
                                <td class="text-center">
                                    <a<?=ae('delete_posts');?> href="#" data-toggle="modal" data-target="#delete-<?= $posttype->getId(); ?>"><button type="button" class="btn bg-red"><i class="fa fa-trash"></i></button></a>
