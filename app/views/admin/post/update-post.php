...
TriTan\Common\Container::getInstance()->{'set'}('post_id', $this->post->getId());
        ...
        <div class="box box-solid">
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    <?= Nonce::field("update-post-{$this->post->getId()}"); ?>
                    ...
                    <button type="submit"<?=ae('update_posts');?> class="btn btn-success"><i class="fa fa-pencil-alt"></i> <?= esc_html__('Update'); ?></button>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="post_parent" style="width: 100%;">
                                    ...
                                    <?php get_post_parent_dropdown_list((int) $this->post->getParent(), (int) $this->post->getId()); ?>
                                </select>
                            </div>
                            <div class="form-group">
