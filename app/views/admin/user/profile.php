        ...
        <div class="box box-solid">
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    <?= Nonce::field('my-profile'); ?>
                    <input type="hidden" name="user_id" value="<?=$this->current_user_id;?>" />
                    <input type="hidden" name="user_role" value="<?= get_role_by_id(get_user_option('role', (int) $this->current_user_id))['role']['role_id']; ?>" />
        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?= esc_html__('Date/Time'); ?></h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="form-group">
                                <label><strong><?= esc_html__('Timezone'); ?></strong></label>
                                <select class="form-control select2" name="user_timezone" style="width: 100%;">
                                    <option value=""> ------------------------- </option>
                                    <?php foreach (generate_timezone_list() as $k => $v) : ?>
                                        <option value="<?=$k;?>"<?=selected($user->getTimezone(), $k, false); ?>><?=$v;?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="user_date_format" value="<?= $user->getDateFormat(); ?>" />
                            </div>

                            <div class="form-group">
                                <label><strong><?= esc_html__('Time Format'); ?></strong></label>
                                <input type="text" class="form-control" name="user_time_format" value="<?= $user->getTimeFormat(); ?>" />
                            </div>
                             ...
                             * @param array $user User object.
                             */
                            hook::getInstance()->{'doAction'}('user_profile_datetime', $user);
                            ?>
                        </div>
                    </div>
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?= esc_html__('Locale'); ?></h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="form-group">
                                <label><strong><?= esc_html__('Language'); ?></strong></label>
                                <select class="form-control select2" name="user_locale" style="width: 100%;">
                                    <option value=""> ------------------------- </option>
                                    <?php ttcms_dropdown_languages($user->getLocale()); ?>
                                </select>
                            </div>
                             ...
                             * @param array $user User object.
                             */
                            hook::getInstance()->{'doAction'}('user_profile_locale', $user);
                            ?>
