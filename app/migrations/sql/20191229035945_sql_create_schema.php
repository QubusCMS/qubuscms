...
class SqlCreateSchema extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function change()
    {
        ...
        $table
            ->addColumn('option_id', 'integer', ['identity' => true])
        ...
        $table
            ->addColumn('permission_id', 'integer', ['identity' => true])
        ...
        $table
            ->addColumn('plugin_id', 'integer', ['identity' => true])
        ...
        $table
            ->addColumn('post_id', 'integer', ['identity' => true])
            ->addColumn('post_title', 'string', ['limit' => 191])
            ->addColumn('post_slug', 'string', ['limit' => 191])
            ->addColumn('post_content', 'text')
            ->addColumn('post_author', 'integer', ['null' => true])
            ->addColumn('post_posttype', 'string', ['limit' => 191])
            ->addColumn('post_parent', 'integer', ['null' => true])
            ->addColumn('post_sidebar', 'integer', ['default' => '0'])
            ->addColumn('post_show_in_menu', 'integer', ['default' => '0'])
            ->addColumn('post_show_in_search', 'integer', ['default' => '0'])
            ->addColumn('post_relative_url', 'string', ['limit' => 191])
            ->addColumn('post_featured_image', 'string', ['limit' => 191])
        ...
        $table
            ->addColumn('meta_id', 'integer', ['identity' => true])
        ...
        $table
            ->addColumn('posttype_id', 'integer', ['identity' => true])
            ->addColumn('posttype_title', 'string', ['limit' => 191])
            ->addColumn('posttype_slug', 'string', ['limit' => 191])
            ->addColumn('posttype_description', 'text', ['null' => true])
        ...
        $table
            ->addColumn('site_id', 'integer', ['identity' => true])
        ...
        $table
            ...
            ->addColumn('user_addedby', 'integer', ['null' => true])
            ->addColumn('user_registered', 'datetime', [])
            ->addColumn('user_modified', 'datetime', ['default' => '0000-00-00 00:00:00'])
