                            ...
                            <tr class="gradeX">
                                ...
                                <td class="text-center">
                                    <?php if (!isset($this->app->req->cookie['SWITCH_USERBACK']) && (int) $user->getId() !== $this->current_user_id) : ?>
                                        <a<?= ae('switch_user'); ?> href="<?= admin_url('user/' . (int) $user->getId() . '/switch-to/'); ?>" data-toggle="tooltip" data-placement="top" title="Switch to"><button type="button" class="btn bg-blue"><i class="fa fa-exchange-alt"></i></button></a>
                                    <?php endif; ?>
                                    <?php if ((int) $user->getId() !== 1) : ?>
                                        <a<?= ae('delete_users'); ?> href="#" data-toggle="modal" data-target="#delete-<?= (int) $user->getId(); ?>"><button type="button" class="btn bg-red"><i class="fa fa-trash"></i></button></a>
                                    <?php endif; ?>
