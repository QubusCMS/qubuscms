...
TriTan\Common\Container::getInstance()->{'set'}('screen_parent', 'sites');
TriTan\Common\Container::getInstance()->{'set'}('screen_child', 'sites');
?>
                                ...
                                <tbody>
                                    <?php foreach ($this->sites as $site) : ?>
                                        <tr class="gradeX">
                                            ...
                                            <td class="text-center">
                                                <button type="button"<?= ae('update_sites');?> class="btn btn-success" onclick="window.location = '<?= admin_url('site/' . (int) $site->getId() . '/'); ?>'"><i class="fa fa-pencil-alt"></i></button>
                                                <?php if ((int) $site->getId() <> 1) : ?>
                                                <button type="button"<?= ae('delete_sites'); ?> class="btn bg-red" data-toggle="modal" data-target="#delete-<?= $site->getId(); ?>"><i class="fa fa-trash"></i></button>
                                                <?php endif; ?>
