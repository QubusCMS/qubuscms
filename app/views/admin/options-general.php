...
TriTan\Common\Container::getInstance()->{'set'}('screen_child', 'options-general');
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <?php ActionFilterHook::getInstance()->{'doAction'}('options_general_form'); ?>
                            </div>
                            <!-- /.box-body -->
                        </div>
                        <!-- /.box-body -->
