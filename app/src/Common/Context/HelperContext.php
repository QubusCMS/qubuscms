...
final class HelperContext implements \TriTan\Interfaces\ContextInterface
{
    public $obj = [];
    ...
    public function __construct()
    {
        ...
        $this->obj['hook'] = \Qubus\Hooks\ActionFilterHook::getInstance();
        ...
        $this->obj['meta'] = new \TriTan\Common\MetaData($this->obj['app']->qudb, $this);
        ...
        $this->obj['ip'] = new \TriTan\Common\Ip();
        return $this->obj;
    }
}
