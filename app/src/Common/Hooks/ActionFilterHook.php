...
final class ActionFilterHook implements
    ...
    HasActionHookInterface
{
     ...
     * @const int
     */
    protected const PRIORITY_NEUTRAL = 10;
     ...
     * @access public
     * @since    1.0.0
     * @param    string               $hook             The name of the Qubus CMS action that is being registered.
    ...
    */
     ...
     */
    protected function buildUniqueId($hook, $function, $priority)
    {
     ...
     */
    protected function callAllHook($args)
    {
